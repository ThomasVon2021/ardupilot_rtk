...
| Frequencies                    | BDS B1I/B2I1<br> GPS L1/L2 GLONASS L1/L2<br> Galileo E1/E5b<br> QZSS L1/L2 |
|--------------------------------|----------------------------------------------------------------------------|
...
The GRTK module supports dual antenna direction finding, where the left antenna is the master antenna, the right antenna is the slave antenna, and the single antenna needs to be connected to the master antenna.
...
AliExpress: GRTK ([BLI Store](https://pt.aliexpress.com/store/911931677?spm=a2g0o.detail.1000007.1.39015121XTYCWP))
